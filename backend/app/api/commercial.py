...
from .dependencies import get_commercial_service, get_demo_persona
...
def get_subscription(service: CommercialService = Depends(get_commercial_service), persona: dict = Depends(get_demo_persona)) -> dict:
...
def checkout(request: CommercialCheckoutRequest, service: CommercialService = Depends(get_commercial_service), persona: dict = Depends(get_demo_persona)) -> dict:
...
def cancel_subscription(service: CommercialService = Depends(get_commercial_service), persona: dict = Depends(get_demo_persona)) -> dict:
